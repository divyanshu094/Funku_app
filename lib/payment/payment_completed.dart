  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Scaffold(
        ...
        body: Padding(padding: const EdgeInsets.only(left: 28,right: 28,top: 10,bottom: 25),
        child: Column(
          children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                     Text("Payment Completed", style: GoogleFonts.merriweather(
                       fontSize: 24,
                ...
                SizedBox(
                 ...
                 Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text("Order Number is: ",style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                      fontWeight: FontWeight.w400 )
                      ),
                      Text("948576943856",style: TextStyle(
                      color: Colors.white,
                      fontSize: 16,
                 ...
                 Icon(Icons.square,size: 225,color: Colors.white,),
                 SizedBox(
                  height: MediaQuery.of(context).size.height*0.01,
                 ),
                 Wrap(
                  children: [
                    Text("You will receive an email confirmation shortly at username@email.com",style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w400 )
                      ),
                 ...
                 Row(
                  ...
                  children: [
                    ...
                    Text("Detailed Order Receipt",style: TextStyle(
                      color: Colors.white,
                      fontSize: 14,
                      fontWeight: FontWeight.w400 )
                      ),
                 ...
                 Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    SvgPicture.asset("assets/payment/arrowLeftCurvedCircle.svg"),
                    SizedBox(
                      width: 14,
                    ),
