          ...
          child: Column(
            children: [
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Text("“You can select upto 3”", style: GoogleFonts.merriweather(
                    fontSize: 12,
              ...
              ElevatedButton(
                      ...
                      onPressed: () {
                           ...
                           child: Text("Let’s party",style: TextStyle(
      ...
      choices.add(Container(
        ...
        child: ChoiceChip(
          ...
          labelStyle: TextStyle( 
              color: Color.fromARGB(255, 32, 9, 99), fontSize: 14.0, fontWeight: FontWeight.w500),
