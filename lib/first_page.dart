          ...
          body: Stack(
            children: [
              ...
              SingleChildScrollView(
                child: Container(
                  padding: EdgeInsets.only(top: MediaQuery.of(context).size.height*0.54, right: 24,left: 24),
                ...
                children:[
                  ...
                  Text("Let's get the party started!", style: GoogleFonts.merriweather(
                    fontSize: 24,
                    ...
                    children: [
                      TextSpan(
                        ...
                        style: const TextStyle(
                            ...
                            fontWeight: FontWeight.w700),
                        recognizer: TapGestureRecognizer()
                          ..onTap = () =>  Navigator.of(context).push(MaterialPageRoute(builder: (context) => PriPolicy())),
                      )
                    ]),
              ),
                      ),
